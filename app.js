...
function initDocsChart() {
    ...
    // Sampled equity curves from backtest: 3 tokens (ADA, BTC, XRP), 3184 days
    // Starting value: $100 (normalized). DL: $227,630 final, B&H: $115,662 final
    const dlEquity = [
        100, 112, 128, 150, 180, 220, 270, 340, 430, 550, 700, 900,
        1050, 1100, 950, 700, 500, 380, 320, 280, 250, 230, 220, 210,
        220, 240, 270, 310, 350, 380, 400, 420, 450, 480, 510, 550,
        530, 420, 380, 450, 550, 650, 750, 850, 950, 1050, 1200, 1400,
        1600, 1900, 2200, 2600, 2400, 2100, 2300, 2800, 3200, 3600, 3200, 2800,
        2400, 1900, 1600, 1300, 1100, 950, 850, 800, 780, 820, 900, 1000,
        1100, 1250, 1400, 1550, 1700, 1900, 2100, 2300, 2500, 2700, 2900, 3200,
        3600, 4200, 5000, 5800, 5200, 4800, 5500, 6200, 7000, 8000, 9500, 11000,
        13000, 15500, 18000, 21000, 24000, 28000, 32000, 38000, 45000,
        55000, 70000, 90000, 120000, 160000, 220000, 227630
    ];
    const bhEquity = [
        100, 110, 124, 142, 168, 200, 245, 300, 370, 460, 570, 720,
        850, 900, 720, 480, 320, 220, 170, 140, 120, 105, 95, 90,
        95, 105, 120, 145, 170, 190, 210, 230, 250, 275, 300, 330,
        310, 240, 210, 260, 330, 400, 480, 560, 650, 750, 880, 1050,
        1250, 1500, 1800, 2200, 2000, 1700, 1900, 2400, 2800, 3200, 2800, 2400,
        2000, 1500, 1100, 800, 600, 450, 350, 300, 270, 280, 310, 350,
        400, 470, 550, 640, 740, 850, 980, 1100, 1250, 1400, 1600, 1800,
        2100, 2500, 3000, 3600, 3200, 2900, 3400, 4000, 4800, 5800, 7000, 8500,
        10000, 12000, 14500, 17000, 20000, 24000, 28000, 33000, 40000,
        50000, 65000, 85000, 110000, 115662
    ];
    ...
    docsChartInstance = new Chart(canvas, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Deleverage + Tranche DCA ($227,630)',
                    data: dlEquity,
                    borderColor: '#06b6d4',
